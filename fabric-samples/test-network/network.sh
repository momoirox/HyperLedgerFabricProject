...
function createOrgs() {
  ...
  while :
    ...
    createOrg org1 7054 4

    infoln "Creating Org2 Identities"

    createOrg org2 8054 4

    infoln "Creating Org3 Identities"

    createOrg org3 10054 4

    infoln "Creating Org4 Identities"

    createOrg org4 11054 4
 ...
 . organizations/ccp-generate-parametrized.sh
  ...
  # org_name | org_id | CORE_PEER_ADDRESS | FABRIC_CA_SERVER_PORT PEERPEM CAPEM
  ...
  CAPEM=organizations/peerOrganizations/org3example.com/ca/ca.org3.example.com-cert.pem
  ...
  CAPEM=organizations/peerOrganizations/org4.example.com/ca/ca.org4.example.com-cert.pem
   ...
   ccp-generate org4 4 12051 11054 $PEERPEM $CAPEM
